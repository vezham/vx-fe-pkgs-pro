...
import {
  ...
  tabItemProps,
  TabProps
} from '@vx-pro/application-navigationheader-brandcolors'
import React from 'react'
const navigationheaders_brandcolors = () => {
  ...
  const tabs: TabProps = {
    title: ' Dashboard',
    subtitle: ' Manage your deployments',
    actions: (
      <Button
        color="primary"
        startContent={
  ...
  return (
    <div>
      <NavigationHeaderBrandcolors data={data} tabs={tabs} />
    </div>
  )
}

export default navigationheaders_brandcolors
