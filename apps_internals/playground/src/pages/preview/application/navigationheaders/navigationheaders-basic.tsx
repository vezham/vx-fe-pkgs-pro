...
import {
  IconSvgProps,
  NavigationHeaderBasic,
  navigationHeaderProps,
  NotificationItem,
  NotificationItemProps,
  NotificationTabs,
  NotificationType
} from '@vx-pro/application-navigationheader-basic'
import React from 'react'

const navigationheaders_basic = () => {
  ...
  return (
    <div>
      {' '}
      <NavigationHeaderBasic data={data} />{' '}
    </div>
  )
}

export default navigationheaders_basic
