...
import {
  ...
  tabItemProps
} from '@vx-pro/application-navigationheader-tabs'
import React from 'react'

const navigationheaders_tabs = () => {
  ...
  return (
    <div>
      <NavigationHeaderTabs data={data} tabs={tabs} />
    </div>
  )
}

export default navigationheaders_tabs
