...
import {
  ...
  tabItemProps,
  TabProps
} from '@vx-pro/application-navigationheader-cta'
import React from 'react'

const navigationheaders_cta = () => {
    ...
    actions: (
      <>
        <Button
          ...
          startContent={
            <Icon
              className="text-background/60 flex-none"
              icon="lucide:plus"
              width={16}
            />
          }>
  ...
  return (
    <div>
      <NavigationHeaderCta data={data} tabs={tabs} />
    </div>
  )
}

export default navigationheaders_cta
