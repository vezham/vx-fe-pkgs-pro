...
import { Avatar, Badge, Button } from '@vx-oss/react'
import {
  CardAccountDetails,
  cardProps,
  countryProp
} from '@vx-pro/application-card-accountdetails'

const card_accountdetails = () => {
  ...
  return (
    <div>
      <CardAccountDetails data={data} />
    </div>
  )
}

export default card_accountdetails
