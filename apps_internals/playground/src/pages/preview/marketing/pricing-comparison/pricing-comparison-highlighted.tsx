import {
  Frequency,
  FrequencyEnum,
  PricingComparisonHighlighted,
  PricingFeatures,
  pricingProps,
  Tier,
  TiersEnum
} from '@vx-pro/marketing-pricingcomparison-highlightedtier'

const pricing_comparison_highlighted = () => {
...
export default pricing_comparison_highlighted
