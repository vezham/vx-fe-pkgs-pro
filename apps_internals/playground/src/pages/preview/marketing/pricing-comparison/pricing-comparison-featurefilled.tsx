import {
  Frequency,
  FrequencyEnum,
  PricingComparisonFeaturedFilled,
  PricingFeatures,
  pricingProps,
  Tier,
  TiersEnum
} from '@vx-pro/marketing-pricingcomparison-featuredtierfilled'

const pricing_comparison_featuredfilled = () => {
...
export default pricing_comparison_featuredfilled
