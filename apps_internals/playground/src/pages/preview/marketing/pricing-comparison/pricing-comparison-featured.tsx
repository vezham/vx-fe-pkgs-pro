import {
  Frequency,
  FrequencyEnum,
  PricingComparisonFeatured,
  PricingFeatures,
  pricingProps,
  Tier,
  TiersEnum
} from '@vx-pro/marketing-pricingcomparison-featuredtier'

const pricing_comparison_featured = () => {
...
export default pricing_comparison_featured
