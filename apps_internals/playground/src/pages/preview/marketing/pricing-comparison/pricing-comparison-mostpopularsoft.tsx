import {
  ...
  FrequencyEnum,
  PricingFeatures,
  PricingMostPopularSoft,
  pricingProps,
  Tier,
  TiersEnum
} from '@vx-pro/marketing-pricingcomparison-mostpopulartiersoft'

const pricing_comparison_mostpopularsoft = () => {
...
export default pricing_comparison_mostpopularsoft
