import {
  Frequency,
  FrequencyEnum,
  PricingComparisonBlurred,
  PricingFeatures,
  pricingProps,
  Tier,
  TiersEnum
} from '@vx-pro/marketing-pricingcomparison-blurredbackground'

const pricing_comparison_blurred = () => {
...
export default pricing_comparison_blurred
