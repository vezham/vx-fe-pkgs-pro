...
import {
  heroSectionProps,
  HeroSectionScreenshot,
  IconSvgProps,
  NavProps
} from '@vx-pro/marketing-herosections-screenshot'
...
const herosection_screenshot = () => {
  ...
  return (
    <div>
      <HeroSectionScreenshot data={data} />
    </div>
  )
}

export default herosection_screenshot
