import {
  ...
  Tier,
  TiersEnum
} from '@vx-pro/marketing-pricing-basicprice'

const pricing_baseprice = () => {
  ...
  return (
    <div>
      <BasePrice data={data} frequencies={frequencies} tiers={tiers} />
    </div>
  )
}

export default pricing_baseprice
