import {
  ...
  Tier,
  TiersEnum
} from '@vx-pro/marketing-pricing-mostpopulartier-highlighted'

const pricing_mostpopulartier_highlighted = () => {
  ...
  return (
    <div>
      <Pricing data={data} frequencies={frequencies} tiers={tiers} />
    </div>
  )
}

export default pricing_mostpopulartier_highlighted
