...
import {
  CookieFloatingBottom,
  cookieProps
} from '@vx-pro/marketing-cookies-floatingbottom'

const cookies_floatingbottom = () => {
  ...
  return (
    <div>
      <CookieFloatingBottom data={data} />
    </div>
  )
}

export default cookies_floatingbottom
