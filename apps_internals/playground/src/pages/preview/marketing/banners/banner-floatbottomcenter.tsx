...
import {
  BannerFloatBottomCenter,
  bannerProps
} from '@vx-pro/marketing-banner-floatingbottomcenter'

const banner_floatbottomcenter = () => {
  ...
  return (
    <div>
      <BannerFloatBottomCenter data={data} />
    </div>
  )
}

export default banner_floatbottomcenter
