...
import {
  BannerBetweenJustified,
  bannerProps
} from '@vx-pro/marketing-banner-betweenjustified'

const banner_betweenjustified = () => {
  ...
  return (
    <div>
      <BannerBetweenJustified data={data} />
    </div>
  )
}

export default banner_betweenjustified
