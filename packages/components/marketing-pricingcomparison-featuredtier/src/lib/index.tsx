...
const PricingComparisonFeatured = ({
  data,
  frequencies,
  tiers,
  features
  ...
  const featuredBeforeColumnBg = cn(
    beforeColumnBg,
                  ...
                  <th
                    ...
                    className={cn('relative px-6 pt-6 xl:px-8 xl:pt-8', {
                      [`${mostPopularBeforeColumnBg} before:rounded-t-medium`]:
                        tier.mostPopular,
                      [`${featuredBeforeColumnBg} before:rounded-t-medium`]:
                        tier.featured
                    })}
                    scope="col">
                    {tier.mostPopular ? (
                    ...
                    <div
                      className={cn(
                        'text-large text-foreground relative font-medium',
                        {
                ...
                {tiers.map(tier => (
                  <td
                    ...
                    <div className="text-foreground flex items-baseline gap-1">
                      ...
                      <span
                        className={cn(
                          'text-small! text-default-600 font-medium',
                          {
...
export { PricingComparisonFeatured }
